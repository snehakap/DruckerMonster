...
export function ProductDetails() {
  ...
  <Link
    to="/contact"
    className="group px-8 py-4 bg-[rgb(0,146,82)] text-white rounded-xl hover:bg-emerald-700 transition-all duration-300 flex items-center justify-center font-semibold"
  >
    Jetzt kaufen
  </Link>
  ...
  <Link
    to="/contact"
    className="group px-8 py-4 border-2 border-[rgb(0,146,82)] text-[rgb(0,146,82)] rounded-xl hover:bg-emerald-50 transition-all duration-300 flex items-center justify-center font-semibold"
  >
    Kontakt aufnehmen
  </Link>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-15">
          {product.highlights.map((point, index) => (
            ...
            >
              <CheckCircle
                size={24}
                className="text-[rgb(0,146,82)] mt-1"
              />
